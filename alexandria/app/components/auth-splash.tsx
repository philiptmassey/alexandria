  ...
  return (
    <div className="auth-page">
      <main className="auth-card">
        <span className="brand-mark auth-mark" aria-hidden="true">A</span>
        <p className="auth-eyebrow">Alexandria</p>
        <h1>Your reading, quietly organized.</h1>
        <p>Save the papers and essays worth returning to. Read them when the time is right.</p>
        <button
          type="button"
